...
// 1. EXPORT THE CSS RULES SEPARATELY
// We remove isDashboardEditMode to prevent errors and default to sticky headers
export const pivotTableCss = (theme) => css`
  table.pvtTable {
    position: relative;
...
// 2. KEEP THE COMPONENT EXPORT
// This prevents the "Minified React error #130" crash in other files
